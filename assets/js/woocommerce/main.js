(function ($) {
    ...
    function tooltip() {
        ...
        $('body').on('mouseenter', '.group-action .shop-action .woosw-btn:not(.tooltipstered), .group-action .shop-action .woosq-btn:not(.tooltipstered), .group-action .shop-action .woosc-btn:not(.tooltipstered), .group-action .opal-add-to-cart-button:not(.tooltipstered)', function () {
            var $element = $(this);
    ...
    function quick_product_variable() {
        ...
        $(document).on('click', btnSelector, function (e) {
            ...
            if ($product.hasClass('quick-shop-loaded')) {
                ...
                $('body').trigger('vonaco-quick-view-displayed');
                return;
            }
            ...
            $.ajax({
                url: vonacoAjax.ajaxurl,
                data: {
                    action: 'vonaco_quick_shop',
                    id: id,
                },
                method: 'get',
                success: function (data) {
                    ...
                    // vonacoThemeModule.swatchesVariations();
            ...
            // Ajax action.
            xhr = $.ajax({
                url: wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'vonaco_add_to_cart'),
                data: formData,
                type: 'POST',
                processData: false,
                contentType: false,
