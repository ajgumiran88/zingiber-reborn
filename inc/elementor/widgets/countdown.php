...
class Vonaco_Elementor_Countdown extends Elementor\Widget_Base {

    public function get_name() {
        return 'vonaco-countdown';
    }

    public function get_title() {
        return esc_html__('Vonaco Countdown', 'vonaco');
    }
    ...
    public function get_script_depends() {
        return ['vonaco-elementor-countdown'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => esc_html__('Countdown', 'vonaco'),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label'       => esc_html__('Due Date', 'vonaco'),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => date('Y-m-d H:i', strtotime('+1 month') + (get_option('gmt_offset') * HOUR_IN_SECONDS)),
                /* translators: %s: Time zone. */
                'description' => sprintf(esc_html__('Date set according to your timezone: %s.', 'vonaco'), Utils::get_timezone_string()),
            ]
        );
        ...
        $this->add_control(
            'show_days',
            [
                'label'     => esc_html__('Days', 'vonaco'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'vonaco'),
                'label_off' => esc_html__('Hide', 'vonaco'),
                'default'   => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_minutes',
            [
                'label'     => esc_html__('Minutes', 'vonaco'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'vonaco'),
                'label_off' => esc_html__('Hide', 'vonaco'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label'     => esc_html__('Seconds', 'vonaco'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'vonaco'),
                'label_off' => esc_html__('Hide', 'vonaco'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label'     => esc_html__('Show Label', 'vonaco'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'vonaco'),
                'label_off' => esc_html__('Hide', 'vonaco'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label'     => esc_html__('Custom Label', 'vonaco'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Days', 'vonaco'),
                'placeholder' => esc_html__('Days', 'vonaco'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_days'      => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Hours', 'vonaco'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Hours', 'vonaco'),
                'placeholder' => esc_html__('Hours', 'vonaco'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_hours'     => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Minutes', 'vonaco'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Minutes', 'vonaco'),
                'placeholder' => esc_html__('Minutes', 'vonaco'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_minutes'   => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Seconds', 'vonaco'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Seconds', 'vonaco'),
                'placeholder' => esc_html__('Seconds', 'vonaco'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_seconds'   => 'yes',
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => esc_html__('Container Width', 'vonaco'),
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-vonaco-countdown' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => esc_html__('Items Width', 'vonaco'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => esc_html__('Items Height', 'vonaco'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.elementor-widget-vonaco-countdown .elementor-countdown-item:before' => 'right: -{{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'   => 'center',
                'selectors' => [
                    '{{WRAPPER}} .elementor-vonaco-countdown' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'digits_color',
            [
                'label'     => esc_html__('Color digit', 'vonaco'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'digits_color_2',
            [
                'label'       => esc_html__('Bg Color digit', 'vonaco'),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => [
                    '{{WRAPPER}} .elementor-countdown-digits'        => 'background: {{VALUE}};',
                ],
                'description' => esc_html__('Background Or Border Color', 'vonaco'),
            ]
        );
        ...
        $this->add_responsive_control(
            'digits_padding',
            [
                'label'      => esc_html__('Padding digits', 'vonaco'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            'digits_margin',
            [
                'label'      => esc_html__('Margin digits', 'vonaco'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $this->add_control(
            'label_color',
            [
                'label'     => esc_html__('Color label', 'vonaco'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'decor_color',
            [
                'label'     => esc_html__('Color decor', 'vonaco'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months'  => esc_html__('Months', 'vonaco'),
            'label_weeks'   => esc_html__('Weeks', 'vonaco'),
            'label_days'    => esc_html__('Days', 'vonaco'),
            'label_hours'   => esc_html__('Hours', 'vonaco'),
            'label_minutes' => esc_html__('Minutes', 'vonaco'),
            'label_seconds' => esc_html__('Seconds', 'vonaco'),
        ];
    }
    ...
    protected function render() {
        ...
        ?>
        <div class="elementor-vonaco-countdown" data-date="<?php echo esc_attr($due_date); ?>">
            <?php echo vonaco_elementor_get_strftime($instance, $this); // WPCS: XSS ok. ?>
        </div>
        <?php
    }
}

$widgets_manager->register(new Vonaco_Elementor_Countdown());
