...
class Vonaco_Call_To_Action extends Elementor\Widget_Base {

    public function get_name() {
        return 'vonaco-banner';
    }

    public function get_title() {
        return esc_html__( 'Vonaco Banner', 'vonaco' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Image Resolution', 'vonaco' ),
                'default' => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label' => esc_html__( 'Graphic Element', 'vonaco' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'vonaco' ),
                        'icon' => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'vonaco' ),
                        'icon' => 'fa fa-picture-o',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'vonaco' ),
                        'icon' => 'eicon-star',
                    ],
                ],
                'default' => 'none',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'default' => esc_html__( 'Default', 'vonaco' ),
                    'stacked' => esc_html__( 'Stacked', 'vonaco' ),
                    'framed' => esc_html__( 'Framed', 'vonaco' ),
                ],
                'default' => 'default',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => esc_html__( 'Shape', 'vonaco' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'circle' => esc_html__( 'Circle', 'vonaco' ),
                    'square' => esc_html__( 'Square', 'vonaco' ),
                ],
                'default' => 'circle',
                'condition' => [
                    'icon_view!' => 'default',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'This is the sub title', 'vonaco' ),
                'placeholder' => esc_html__( 'Enter your sub title', 'vonaco' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'title',
            [
                'label' => esc_html__( 'Title & Description', 'vonaco' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the heading', 'vonaco' ),
                'placeholder' => esc_html__( 'Enter your title', 'vonaco' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'vonaco' ),
                'placeholder' => esc_html__( 'Enter your description', 'vonaco' ),
                'separator' => 'none',
                'rows' => 5,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => esc_html__( 'Title HTML Tag', 'vonaco' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $this->add_control(
            'button',
            [
                'label' => esc_html__( 'Button Text', 'vonaco' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            'link_click',
            [
                'label' => esc_html__( 'Apply Link On', 'vonaco' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => esc_html__( 'Whole Box', 'vonaco' ),
                    'button' => esc_html__( 'Button Only', 'vonaco' ),
                ],
                'default' => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label' => esc_html__( 'Stretch', 'vonaco' ),
        ...
        $this->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'vonaco' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
                    ...
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'vonaco' ),
        ...
        $this->add_control(
            'show_bg',
            [
                'label'     => esc_html__( 'Show Bg gradien', 'vonaco' ),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_control(
            'graphic_image_hover',
            [
                'label' => esc_html__( 'Image Effect', 'vonaco' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'icon_primary_color',
            [
                'label' => esc_html__( 'Primary Color', 'vonaco' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secondary Color', 'vonaco' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_padding',
            [
                'label' => esc_html__( 'Icon Padding', 'vonaco' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Subtitle', 'vonaco' ),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Hover', 'vonaco' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Colors', 'vonaco' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label' => esc_html__( 'Sub title Color', 'vonaco' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label' => esc_html__( 'Description Color', 'vonaco' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color', 'vonaco'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_style_theme',
            [
                'label'        => esc_html__('Button Style', 'vonaco'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
        ...
        $this->add_control(
            'divider_color',
            [
                'label' => esc_html__( 'Divider Color', 'vonaco' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__( 'Hover Effects', 'vonaco' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'transformation',
            [
                'label' => esc_html__( 'Hover Animation', 'vonaco' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => 'None',
                    'zoom-in' => 'Zoom In',
        ...
        $this->add_control(
            'overlay_color',
            [
                'label' => esc_html__( 'Overlay Color', 'vonaco' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'overlay_blend_mode',
            [
                'label' => esc_html__( 'Blend Mode', 'vonaco' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__( 'Normal', 'vonaco' ),
                    'multiply' => 'Multiply',
                    'screen' => 'Screen',
                    'overlay' => 'Overlay',
                    'darken' => 'Darken',
        ...
        $this->add_control(
            'effect_duration',
            [
                'label' => esc_html__( 'Transition Duration', 'vonaco' ),
                'type' => Controls_Manager::SLIDER,
...
//        $content_animation = $settings['content_animation'];
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . vonaco_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-vonaco-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo vonaco_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo vonaco_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo vonaco_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo vonaco_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo vonaco_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <span><?php printf('%s', $settings['subtitle']); ?></span>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . vonaco_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo vonaco_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . vonaco_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
                    <?php echo esc_html($settings['button']); ?>

                            <i class="vonaco-icon-arrow-circle"></i>
                </span>
...
$widgets_manager->register(new Vonaco_Call_To_Action());
