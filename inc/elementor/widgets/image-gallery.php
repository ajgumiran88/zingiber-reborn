 ...
 * @since 1.0.0
 */
class Vonaco_Elementor_Image_Gallery extends Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Vonaco Image Gallery', 'vonaco');
    }
    ...
    public function get_script_depends()
    {
        return [
            'isotope',
            'vonaco-elementor-image-gallery'
        ];
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => esc_html__('Image Gallery', 'vonaco'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label' => esc_html__('Filter Title', 'vonaco'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('List Item', 'vonaco'),
                'default' => esc_html__('List Item', 'vonaco'),
            ]
        );
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label' => esc_html__('Add Images', 'vonaco'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'filter_title' => esc_html__('Gallery 1', 'vonaco'),
                    ],
                ],
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label' => esc_html__('Filter Bar', 'vonaco'),
        ...
        $this->add_responsive_control(
            'item_spacing_top',
            [
                'label'      => esc_html__('Spacing Top', 'vonaco'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
                ...
                'size_units' => ['px', 'em'],
                'selectors'  => [
                    '{{WRAPPER}}.elementor-widget-vonaco-image-gallery .column-item:nth-child(even)' => 'margin-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}.elementor-widget-vonaco-image-gallery .vonaco-carousel .slick-list .slick-slide:nth-child(even)' => 'margin-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'filter_item_spacing',
            [
                'label' => esc_html__('Space Between', 'vonaco'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label' => esc_html__('Filter Padding', 'vonaco'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->start_controls_section(
            'section_caption',
            [
                'label' => esc_html__( 'Caption', 'vonaco' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Display', 'vonaco' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    '' => esc_html__( 'Show', 'vonaco' ),
                    'none' => esc_html__( 'Hide', 'vonaco' ),
                ],
                'selectors' => [
    ...
    protected function render()
    {
        ...
        if ($settings['show_filter_bar'] == 'yes') {
            ...
            <ul class="elementor-galerry__filters"
                ...
                <li class="elementor-galerry__filter elementor-active"
                    data-filter=".masonry-item__all"><?php echo esc_html__('All', 'vonaco'); ?>
        ...
        <div class="elementor-opal-image-gallery">
            <div <?php echo vonaco_elementor_get_render_attribute_string('row', $this) ?>>
                <?php
                ...
                foreach ($image_gallery as $index => $item) {
                    ...
                    <div class="column-item grid__item masonry-item__all <?php echo 'gallery_group_' . esc_attr($item['group']); ?>">
                        <a data-elementor-open-lightbox="yes" <?php echo vonaco_elementor_get_render_attribute_string('link', $this); ?>
...
$widgets_manager->register(new Vonaco_Elementor_Image_Gallery());
