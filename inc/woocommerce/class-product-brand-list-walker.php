<?php
/**
 * Vonaco_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        vonaco_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Vonaco_Product_Brand_List_Walker', false)) :

	class Vonaco_Product_Brand_List_Walker extends Walker {
