<?php
/**
 * vonaco WooCommerce Adjacent Products Class
 *
 * @package  vonaco
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Vonaco_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The vonaco WooCommerce Adjacent Products Class
	 */
	class Vonaco_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'vonaco_woocommerce_adjacent_query_args', $args ) );
